 ...
 * @version 2.0.2.1
 * @description 🛡️ DCV NEXSUS Panel: Discord Görev Tamamlayıcı, HypeSquad Değiştirici, 7 Siber Tema, 8 Özel Font ve Discord Araçları.
...
imgPublicUrl = chrome.runtime.getURL('assets/preview_public.png');
    ...
    cleanupPlugin() {
        try {
            ...
            const styles = document.querySelectorAll('style[id^="dqu-"]');
